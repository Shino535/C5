...
<c:choose>
	...
	<c:otherwise>
		...
		<form action="JobRegister.action" method="post" enctype="multipart/form-data">
			...
			<p>職種<input type="text" name="job_type"></p>
			<p>月収<input type="text" name="benefit">円</p>
			<p>年間休日<input type="text" name="holiday">日</p>
			<p>雇用形態<select name="employment">
				<option value="">選択してください</option>
